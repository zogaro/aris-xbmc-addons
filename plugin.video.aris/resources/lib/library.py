...
class cLibrary:
    ...
    def __init__(self):
        ...
        if not self.__sMovieFolder:
            self.__sMovieFolder = 'special://userdata/addon_data/plugin.video.aris/Films'
        ...
        if not self.__sTVFolder:
            self.__sTVFolder = 'special://userdata/addon_data/plugin.video.aris/Series'
    ...
    def setLibrary(self):
        ...
        sLink = 'plugin://plugin.video.aris/?function=play&site=cHosterGui&sFileName='
    ...
    def getRecords(self):
        ...
        if not folder:
            folder = 'special://userdata/addon_data/plugin.video.aris/Enregistrement'
        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', folder)
